...
将 MNIST 和 CIFAR-10 的所有方法排在同一张表里，方便横向比较哪种方法最稳健。
...
> **GradSmooth α=0.5 是唯一在 MNIST 和 CIFAR-10 上同时实现 MIA 下降 + 准确率提升的方法。**
> Sign-FGSM 在 CIFAR-10 MIA 降幅最大（3.75%），但准确率损失 4.66%，不算双赢。
> Normalized-FGSM 在两个数据集上均使 MIA 变差，是最差防御方案。
